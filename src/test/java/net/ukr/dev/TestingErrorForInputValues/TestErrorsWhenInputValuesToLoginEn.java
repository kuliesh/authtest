...
public class TestErrorsWhenInputValuesToLoginEn extends BaseTests {
    ...
    public void runRusLocalization () throws IntrospectionException{
        logger.info("Переключаємося на англыйську локалізацією");
    ...
    public void test001_checkTitle() throws InterruptedException {
        ...
        logger.info("Текст заголовка відповідає вказанному значенню 'Create Your @UKR.NET Mailbox'");
    }
    ...
    public void test002_checkLoginForPointSt() throws InterruptedException {
        ...
        Thread.sleep(100);
        assertEquals("Your mailbox name can’t use . symbol at the beginning and(or) at the end", $(".input-default__error.is-size-normal").getText());
        logger.info("Повідомлення про використання крапки на початку логіна відповідає вимогам 'Your mailbox name can’t use . symbol at the beginning and(or) at the end'");
    }
    ...
    public void test004_checkLoginForPointDo() throws InterruptedException {
        ...
        $(By.cssSelector("#id-login")).sendKeys("test2..1_0105_001");
        Thread.sleep(100);
        assertEquals(". symbol repeated use is not allowed", $(".input-default__error.is-size-normal").getText());
        logger.info("Повідомлення про використання крапки багаторазово для логіна відповідає вимогам '. symbol repeated use is not allowed'");
    }
    ...
    public void test005_clearLoginField() throws InterruptedException {
        ...
        Thread.sleep(100);
        assertEquals("You can’t leave this empty", $(".input-default__error.is-size-normal").getText());
        logger.info("Повідомлення про незаповнене поле логіну відповідає логіна відповідає вимогам 'You can’t leave this empty'");
    }
    ...
    public void test006_duplicateMail() throws InterruptedException {
        ...
        assertEquals("Unfortunately, someone already got that mailbox", $(".login-suggestions__error").getText());
        logger.info("Повідомлення про зайняте ім'я логіна відповідає вимогам 'Unfortunately, someone already got that mailbox'");
    }
    ...
    public void test007_cirilicSymbol() throws InterruptedException {
        ...
        assertEquals("Your mailbox name can’t use CYRILLIC letters", $(".input-default__error.is-size-normal").getText());
        logger.info("Повідомлення про кириличний символ в імені логіна відповідає вимогам 'Your mailbox name can’t use CYRILLIC letters'");
    }
    ...
    public void test008_symbolNotValid() throws InterruptedException {
        ...
        Thread.sleep(100);
        $(By.cssSelector("#id-login")).sendKeys("test2.1_3004_001`");
        assertEquals("Your mailbox name may use only these symbols _-. (underscore, hyphen and dot)", $(".input-default__error.is-size-normal").getText());
        logger.info("Повідомлення про кириличний символ в імені логіна відповідає вимогам 'Your mailbox name may use only these symbols _-. (underscore, hyphen and dot)'");
    }
